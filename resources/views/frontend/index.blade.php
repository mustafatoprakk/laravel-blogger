            ...
            <div class="container ">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat1.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Textbooks
                    ...
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat2.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Science
                    ...
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat3.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    History
                    ...
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat4.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Biography
                    ...
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat5.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Adventure
                    ...
                    <div class="col-sm-6 col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="frontend/images/cat6.png" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Fantasy
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="client_container ">
                        ...
                        <div class="client_id">
                            <div class="img-box">
                                <img src="frontend/images/c1.jpg" alt="">
                            </div>
                ...
                <div class="col-md-6 mx-auto">
                    <div class="client_container ">
                        ...
                        <div class="client_id">
                            <div class="img-box">
                                <img src="frontend/images/c2.jpg" alt="">
                            </div>
                            <div class="client_name">
                                <h5>
                                    Anna Crowe
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="client_container ">
                        ...
                        <div class="client_id">
                            <div class="img-box">
                                <img src="frontend/images/c3.jpg" alt="">
                            </div>
                            <div class="client_name">
                                <h5>
                                    Hilley James
    ...
    <section class="contact_section layout_padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="img-box">
                        <img src="frontend/images/contact-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
